...
<?php  require("fheader.php"); ?>
    ...
    <div class="container">
      ...
      <!-- /.row -->
         ...
         <?php 
        $womens ="womens";
            $query=mysqli_query($con,"select * from product where category='".$womens."'");
...
Nowadays the lingerie industry is one of the most successful business spheres. We always stay in touch with the latest fashion tendencies - that is why our goods are so popular..
     ...
     <h4 > 
 <a class="btn btn-primary" name="view" style=" width:100%; " href="fshow_items.php?id=<?php echo $S["id"]; ?>" >View</a>   </h4>
