...
function getCallbackUrl()
{
	...
	return 'http://localhost/project/new/index2.php';
}
...
<div class="main">
    ...
    <span><input type="text" id="amount" name="amount" placeholder="Amount" value="<?php echo $p["rs"]; ?>" /></span>    
    </div>
    
    <div class="dv">
    <span class="text"><label>Product Info:</label></span>
    <span><input type="text" id="pinfo" name="pinfo" placeholder="Product Info" value="<?php echo $p["desc"]; ?>" /></span>
    </div>
